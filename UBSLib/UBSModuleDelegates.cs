...
namespace UBSLib
{
    ...
    public delegate Dictionary<string, UBSModule> GetModule();
    ...
    public delegate void ModuleStatusChangedDelegate(string module_id, UBSModuleStatus status);

    //////////////////////////////////////////////////////////////
    public class UBSModuleDelegates
    {
