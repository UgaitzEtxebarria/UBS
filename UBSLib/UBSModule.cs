...
namespace UBSLib
{
    public class UBSModule
    {
        ...
        private UBSModuleStatus m_status;
        public UBSModuleStatus Status
        {
            //
            get
            {
        ...
        //////////////////////////////////////////////////////////////
        public UBSModule(string _id)
        {
            Id = _id;
            Status = UBSModuleStatus.Initializing;
        }
        ...
        public void Error(string message, bool writeInLog = false, bool isModal = true)
        {
            ...
            m_status = UBSModuleStatus.Error;
        }
        ...
        //////////////////////////////////////////////////////////////
        public UBSModule GetModule(string ModuleId)
        {
        ...
        {
            // override in modules
            Status = UBSModuleStatus.Running;
            return true;
        }
        ...
        {
            // override in modules
            Status = UBSModuleStatus.Closed;
            return true;
        }
        //////////////////////////////////////////////////////////////
        public virtual void HandleMessages(UBSMessage message)
        {
            // override in modules
        }
