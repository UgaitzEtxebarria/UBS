...
{
    public partial class UBSFormContainer : Form
    {

        ///////////////////////////////////////////////////////////
        private UBSModuleStatusForm status_form;
        ...
        public UBSFormContainer()
        {
            ...
            status_form = new UBSModuleStatusForm();
        }
        ...
        ///////////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////
        public void AttachModules(Dictionary<string, UBSLib.UBSModule> module_list)
        {
            form_dict = new Dictionary<string, Form>();
            foreach (UBSLib.UBSVisualModule module in module_list.Values.OfType<UBSLib.UBSVisualModule>())
            {
        ...
        public void AddMenuButton(string id, string name)
        {
            ...
            btnModule.Size = new Size(menu_panel.Width - 2, 64);
            btnModule.Location = new Point(0, last_button_index++ * 64);
            btnModule.Text = name.ToString();
            btnModule.Font = new Font(btnModule.Font.FontFamily, 12.0f, FontStyle.Bold);
        ...
        private void UBSFormContainer_Load(object sender, EventArgs e)
        {
            RefreshForm();
        ...
        private void UBSFormContainer_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                status_form.Close();
